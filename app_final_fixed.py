# BESS LCOS Analysis - Streamlit Application (FINAL FIXED VERSION)
# Battery Energy Storage System - Levelized Cost of Storage Analysis
# FIXED: Removed ALL reportlab imports + Fixed Staged Augmentation column error
    ...
    for year in years:
        ...
        if year == 0:
            ...
            cf = {
                ...
                "capacity": base_capacity,  # FIXED: Added this line for consistency
            ...
            cf = {
                ...
                "capacity": total_capacity,  # FIXED: Added this line for consistency
...
def show_analysis_results(title, data, approach_type):
    ...
    with tab3:
        fig = go.Figure()
        # FIXED: Use "capacity" column which now exists in both overbuild and staged
        fig.add_trace(go.Scatter(
